...
export default function NovaNotaFiscal() {
  ...
  return (
    <SidebarProvider>
      <LayoutComSidebar>
        <div className="mt-20 md:mt-10 m-2 mr-4 lg:mr-7 sm:m-4 space-y-4 sm:space-y-6">
          <HeaderPagina
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="space-y-2">
                      ...
                      <Select value={tipoNota} onValueChange={setTipoNota}>
                        <SelectTrigger
                          className="w-full md:max-w-[180px] border-[var(--sidebar-borda)] focus:ring-2 focus:ring-[var(--sidebar-primaria)] transition"
                        >
                    ...
                    <div className="space-y-2">
                      ...
                      <Select value={finalidade} onValueChange={setFinalidade}>
                        <SelectTrigger className="w-full md:max-w-[180px] border-[var(--sidebar-borda)] focus:ring-2 focus:ring-[var(--sidebar-primaria)] transition">
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea
                        ...
                        rows={3}
                        className="w-full md:max-w-[180px] rounded-md border border-[var(--sidebar-borda)] bg-background px-3 py-2 text-sm shadow-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-[var(--sidebar-primaria)] transition"
                      />
                    </div>
                  </div>
                </CardContent>
