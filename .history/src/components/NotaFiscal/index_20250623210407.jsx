        ...
        <div className="mt-20 md:mt-10 m-2 sm:m-4 space-y-4 sm:space-y-6">
          ...
          <Card className="overflow-hidden">
            ...
            <CardContent>
              ...
              <div className="hidden lg:block table-responsive table-container">
                <Table>
                  <TableHeader>
                    <TableRow>
              ...
              <div className="hidden md:block lg:hidden table-responsive table-container">
                <Table className="w-full min-w-[600px]">
                  <TableHeader>
                    <TableRow>
                      <TableHead className="w-2/5">Nota Fiscal</TableHead>
                      <TableHead className="w-2/5">Cliente</TableHead>
                      <TableHead className="w-1/5">Valor</TableHead>
                      ...
                      <TableRow key={nota.id}>
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <div className="min-w-0 flex-1">
                              ...
                              <div className="text-xs text-muted-foreground truncate">
                                Série {nota.serie} | {new Date(nota.data).toLocaleDateString("pt-BR")}
                              </div>
                            </div>
                          </div>
                        </TableCell>
                        <TableCell className="w-2/5">
                          <div className="min-w-0">
                            <div className="font-medium text-sm truncate">{nota.cliente}</div>
