    ...
    >
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <Button
              ...
              "
            >
              <Link to="/dashboard/notas/new" className="flex items-center">
      ...
      <SidebarFooter className="border-t">
        <div className="p-2">
          ...
          <Link to="/logout" title="Sair do sistema">
            <LogOut className="h-5 w-5 text-[var(--destrutivo)] hover:text-[var(--destrutivo-texto)] transition-colors" />
          </Link>
          {/* 
      Se quiser chamar uma função de logout:
