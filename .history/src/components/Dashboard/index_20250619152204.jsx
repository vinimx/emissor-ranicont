  ...
  return (
    <SidebarProvider className="contents">
      <DashboardContent>
        ...
        ${
          idx === 0
            ? "bg-[var(--sidebar-destaque)] hover:bg-[var(--sidebar-accent)]"
            : idx === 1
            ? "bg-[var(--suave)] hover:bg-[var(--sidebar-destaque)]"
            : idx === 2
            ? "bg-[var(--sidebar-accent)] hover:bg-[var(--suave)]"
            : "bg-[var(--destrutivo)] hover:bg-[var(--destrutivo-texto)]"
        }
      `}
              >
            ...
            ${idx === 3 ? "text-[var(--destrutivo-texto)]" : ""}
          `}
                  >
                    {estat.titulo}
                  </CardTitle>
                ...
                <CardContent>
                  <div
                    className={`
            text-2xl font-bold
            ${idx === 3 ? "text-[var(--destrutivo-texto)]" : "text-[var(--sidebar-primaria)]"}
          `}
                  >
                    {estat.value}
                  </div>
                  <p
                    className={`
            text-xs
            ${idx === 3 ? "text-[var(--destrutivo-texto)]" : "text-[var(--suave-texto)]"}
          `}
                  >
                    <span
                      className={
                ...
                <div className="space-y-4">
                  ...
                  ${
                    notasDashboard.status === "Autorizada"
                      ...
                      ? "bg-[var(--sidebar-destaque)] text-[var(--sidebar-destaque-texto)] border border-[var(--sidebar-borda)]"
                      : "bg-[var(--destrutivo)] text-[var(--destrutivo-texto)] border border-[var(--destrutivo-texto)]"
                  }
                `}
                        >
