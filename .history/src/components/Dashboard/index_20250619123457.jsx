...
function DashboardContent() {
  ...
  return (
    <>
      {/* Botão menu-hamburger sempre visível no mobile, estilizado e funcional */}
      {isMobile && (
        <button
          className="md:hidden fixed top-4 left-4 z-[999] bg-[var(--primaria)] text-white p-2 rounded shadow-lg border-2 border-[var(--sidebar-borda)]"
