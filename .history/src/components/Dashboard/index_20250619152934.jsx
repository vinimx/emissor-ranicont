        ...
        <div className="mt-20 md:mt-10 m-4 space-y-6 border-b border-[var(--sidebar-borda)]">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            {estatisticas.map((estat, idx) => {
              ...
              if (idx === 3) {
                // Devoluções
                bg = "bg-[var(--destrutivo)]";
                hover = "hover:bg-[var(--destrutivo-hover)]";
                text = "text-[var(--destrutivo-texto)]";
                icon = "text-[var(--destrutivo-texto)]";
                value = "text-[var(--destrutivo-texto)]";
                changeMinus = "text-[var(--destrutivo-texto)]";
              }
