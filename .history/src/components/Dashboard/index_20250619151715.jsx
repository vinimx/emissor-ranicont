        ...
        <div className="mt-20 md:mt-10 m-4 space-y-6 border-b border-[var(--sidebar-borda)]">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            {estatisticas.map((estat) => (
              <Card key={estat.titulo}>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="text-sm font-medium">
                    {estat.titulo}
                  </CardTitle>
                  <estat.icon className={`h-4 w-4 text-[var(--sidebar-primaria)]`} />
                </CardHeader>
                <CardContent>
                  <div className="text-2xl font-bold text-[var(--sidebar-primaria)]">{estat.value}</div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Card className="md:col-span-1">
              <CardHeader>
                ...
                <CardDescription className="text-[var(--suave-texto)]">Notas emitidas recentemente</CardDescription>
              </CardHeader>
              <CardContent>
