                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <div>
                              ...
                              <div className="text-xs text-muted-foreground">
                                Código: {produto.codigo} • CFOP: {produto.cfop}
                              </div>
                              <div className="text-xs text-muted-foreground">
                                R$ {Number(produto.valorUnitario).toLocaleString("pt-BR", {
                                  minimumFractionDigits: 2,
                                })} • {produto.unidade}
                              </div>
                            </div>
                        ...
                        <TableCell className="text-right">
                          <div className="flex justify-end space-x-1">
                            <Button
                              ...
                              className="hover:bg-[var(--primaria-hover)] transition-colors h-8 w-8 p-0"
                            >
                            ...
                            <Button
                              ...
                              className="hover:brightness-110 transition-colors h-8 w-8 p-0"
                            >
