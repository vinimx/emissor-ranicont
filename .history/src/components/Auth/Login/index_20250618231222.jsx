      ...
      <div className="w-full max-w-md">
        ...
        >
          ...
          <CardContent className="space-y-4">
            ...
            <Button
              className="w-full py-3 rounded-lg font-semibold transition-colors bg-[var(--primaria)] hover:bg-[var(--primaria-hover)]"
              style={{
                fontSize: dynamicFontSize(), // função JS
                boxShadow: isActive ? "0 0 0 2px var(--primaria)" : "none",
              }}
            >
              Entrar
            </Button>
